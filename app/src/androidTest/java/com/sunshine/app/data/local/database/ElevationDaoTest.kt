...
class ElevationDaoTest {
    ...
    @Test
    fun insertAndRetrieveElevation() = runBlocking {
        // Arrange
    ...
    @Test
    fun getElevation_returnsNullForMissing() = runBlocking {
        // Act
    ...
    @Test
    fun insertAll_storesMultipleEntities() = runBlocking {
        // Arrange
        val entities = listOf(
            ElevationEntity(
                gridLat = 46.0,
    ...
    @Test
    fun getElevationsInBounds_returnsCorrectEntities() = runBlocking {
        // Arrange
        val entities = listOf(
            ElevationEntity(
                gridLat = 46.5,
        ...
        val inBounds = elevationDao.getElevationsInBounds(
            north = 48.0,
            south = 46.0,
            east = 10.0,
            west = 8.0,
    ...
    @Test
    fun countInBounds_returnsCorrectCount() = runBlocking {
        // Arrange
        val entities = listOf(
            ElevationEntity(
                gridLat = 46.5,
        ...
        // Act
        val count = elevationDao.countInBounds(
            north = 47.0,
            south = 46.0,
            east = 9.0,
            west = 8.0,
    ...
    @Test
    fun insert_replacesExistingOnConflict() = runBlocking {
        // Arrange
        val original = ElevationEntity(
            gridLat = 46.0,
            gridLon = 8.0,
            latitude = 46.0,
            longitude = 8.0,
